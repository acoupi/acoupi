...
def detections_worker(model, audio_recording_queue, message_detections_queue, detection_filter, recording_filter,sqlitedb):
...
def mqtt_worker(mqtt_messenger, transmission_messagedb, message_detections_queue):
